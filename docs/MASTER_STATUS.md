...
Brand (identity, tone, logo — Level 1)
    ↓
Architecture (Decision Intelligence Engine, Explainability, Phase 3 blueprint, CMG L0)
    ↓
...
| **CMG L1 runtime** | **BLOCKED** — [ADR-0011](./adr/ADR-0011-CMG-L1-Client-Runtime-Authorization.md) Accepted; [Repository Contract](./architecture/CMG-REPOSITORY-CONTRACT-SPECIFICATION.md) Accepted v0.3.1 (does **not** authorize coding); [Admission Pipeline](./architecture/CMG-ADMISSION-PIPELINE-SPECIFICATION.md) Accepted v0.1.3 (does **not** authorize coding). Implementation remains **not authorized**; coding **Not granted**; operational authorities Missing; proof-backed runtime success unavailable/fail-closed; explicit implementation approval pending. Not started / not in progress / not unblocked. |
...
## Product Remediation Gates

### PRG-02 — World News Freshness Enforcement
...
| Architecture | [architecture/PHASE3_ARCHITECTURE_BLUEPRINT.md](./architecture/PHASE3_ARCHITECTURE_BLUEPRINT.md) · [ADR-0010](./adr/ADR-0010-Canonical-Memory-Graph-and-Personal-Intelligence-Memory-Boundaries.md) (CMG L0) · [ADR-0011](./adr/ADR-0011-CMG-L1-Client-Runtime-Authorization.md) (CMG L1 boundary) · [CMG Repository Contract](./architecture/CMG-REPOSITORY-CONTRACT-SPECIFICATION.md) (Accepted v0.3.1) · [CMG Admission Pipeline](./architecture/CMG-ADMISSION-PIPELINE-SPECIFICATION.md) (Accepted v0.1.3) · [CMG dependency map](./architecture/CMG-SPECIFICATION-DEPENDENCY-MAP.md) |
