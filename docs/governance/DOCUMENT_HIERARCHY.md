...
| [ADR-0011 — CMG L1 Client Runtime Authorization](../adr/ADR-0011-CMG-L1-Client-Runtime-Authorization.md) | Accepted (2026-07-24) | `docs/adr/ADR-0011-CMG-L1-Client-Runtime-Authorization.md` — L1 architectural boundary; coding blocked pending Admission Pipeline + remaining executable gates |
