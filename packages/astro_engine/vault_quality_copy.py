...
QUALITY_COPY = {'heat': [['Optional attraction timing',
          ...
          ['Необязательные окна для знакомства',
           ...
           'Если хочется, предложите встречу без давления и оставьте возможность свободно ответить.',
           'Давление, близость или молчание ради оценки в календаре.',
