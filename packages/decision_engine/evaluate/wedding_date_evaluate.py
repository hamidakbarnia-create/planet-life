"""mar-wedding-date EVALUATE — TimingOptTypeEvaluateConfig + Timing Opt runtime."""
...
def _build_wedding_date_request(
...
WEDDING_DATE_TYPE_CONFIG = register_timing_opt_type_evaluate_config(
    TimingOptTypeEvaluateConfig(
        ...
        build_request=_build_wedding_date_request,
...
def evaluate_wedding_date(
    *,
    ...
    """Execute wedding-date EVALUATE via Timing Opt Family runtime."""
...
WEDDING_DATE_EVALUATE_RUNTIME = bind_timing_opt_evaluate_runtime(
    WEDDING_DATE_TYPE_CONFIG,
