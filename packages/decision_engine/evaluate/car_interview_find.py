"""car-interview FIND — VisibilityTypeFindConfig + Visibility runtime."""
...
def _build_car_interview_find_request(
...
CAR_INTERVIEW_FIND_TYPE_CONFIG = register_visibility_type_find_config(
    VisibilityTypeFindConfig(
        ...
        build_request=_build_car_interview_find_request,
...
def find_car_interview(
    *,
    ...
    """Execute car-interview FIND via Visibility Family runtime."""
    return find_visibility(
...
CAR_INTERVIEW_FIND_RUNTIME = bind_visibility_find_runtime(
    CAR_INTERVIEW_FIND_TYPE_CONFIG,
    find_car_interview,
)
