"""bus-product-launch FIND — TimingOptTypeFindConfig + Timing Opt runtime."""
...
def _build_product_launch_find_request(
...
PRODUCT_LAUNCH_FIND_TYPE_CONFIG = register_timing_opt_type_find_config(
    TimingOptTypeFindConfig(
        ...
        build_request=_build_product_launch_find_request,
...
def find_product_launch(
    *,
    ...
    """Execute product-launch FIND via Timing Opt Family runtime."""
    return find_timing_opt(
...
PRODUCT_LAUNCH_FIND_RUNTIME = bind_timing_opt_find_runtime(
    PRODUCT_LAUNCH_FIND_TYPE_CONFIG,
    find_product_launch,
)
