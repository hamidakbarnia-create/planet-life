...
const LANGS: Record<AppLang, Copy> = {
  ...
  fa: {
    ...
    subtitle:
      'رایگان: اصول. Pro: ابزار تصمیم. Premium: گنجینه باز می‌شه. VIP: جولیا در دسترس.',
    cycleMonthly: 'ماهانه',
    cycleYearly: 'سالانه',
    yearlyHint: 'با پرداخت سالانه ۳۰٪ تخفیف',
    popular: 'محبوب',
    current: 'پلن فعلی',
    vaultUnlocks: 'گنجینه رو باز می‌کنه',
    back: '→ بازگشت',
    ...
    tiers: {
      ...
      premium: {
        name: 'Premium',
        tagline: 'گنجینه باز می‌شه.',
        monthly: '۱۸۰ درهم · ۴۹ دلار',
        yearly: '۱٬۴۴۰ درهم · ۳۹۹ دلار',
        cta: 'باز کردن گنجینه',
        features: [
          'هر چیزی که Pro داره',
          'گنجینه — جذابیت · بدن · حامی',
          'گنجینه — اتاق سایه · تقویم قدرت',
      ...
      vip: {
        ...
        details: [
          ...
          {
            heading: 'Pink Lounge',
            body: 'اتاق‌های فقط زنان تأییدشده داخل گنجینه. فقط نام مستعار. رمزنگاری دو سر. موضوع‌ها رو جولیا هفتگی می‌چینه.',
          },
          {
