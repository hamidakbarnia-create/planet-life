...
> = {
  ...
  fa: {
    ...
    noPeopleBody:
      'قبل از اجرای این خوانش، کسی را در افراد اضافه کنید.',
...
export const VAULT_MISSING_INPUT_COPY: Record<AppLang, VaultMissingInputCopy> = {
  ...
  fa: {
    ...
    genericPartial:
      'این خوانش ناقص است. چند جزئیات بیشتر اضافه کنید تا راهنمایی دقیق‌تر شود.',
    byKind: {
      birth_profile:
      ...
      partner_profile:
        'این خوانش ناقص است. پروفایل این فرد را کامل کنید — تاریخ و مکان تولدش را اضافه کنید.',
      partner_birth_time:
        'این خوانش ناقص است. ساعت تولد او را اضافه کنید تا جزئیات تایمینگ دقیق‌تر شود.',
    },
  },
  ru: {
    goProfile: 'В профиль',
