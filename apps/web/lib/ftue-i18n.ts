...
export const PROFILE_ONBOARDING_COPY = {
  ...
  sub: 'We use date, time, and city to anchor timing. Gender personalizes presentation where it matters — not personality labels.',
  ...
  whyBody:
    'Date, time, and place set the timing reference. Gender personalizes presentation for capabilities that need it — never the scoring engine.',
