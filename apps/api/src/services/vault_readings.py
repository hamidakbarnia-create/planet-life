...
def _radar_questions(relationship_type: str, lang: str) -> list[str]:
    bank = {
        ...
        "fa": {
            "romantic": [
                "چه چیزی گفتن حرف سخت را برای شما امن‌تر می‌کند؟",
                "وقتی فضا می‌خواهید، چطور آن را بخوانم؟",
...
def _trust_questions(relationship_type: str, lang: str) -> list[str]:
    bank = {
        ...
        "fa": {
            "romantic": [
                "چه چیزی حس ثبات عاطفی با من را برای شما آسان می‌کند؟",
...
def _comm_risk_questions(relationship_type: str, lang: str) -> list[str]:
    bank = {
        ...
        "fa": {
            "romantic": [
                "چه چیزی از حرفم شنیدید — با کلمات خودتان؟",
                "وقتی ساکت می‌شوید باید چه فرض کنم؟",
